    ...
    <div className="relative z-10 w-full max-w-md">
      <div className="rounded-2xl border border-[#1e293b] bg-[#0a0e1a] p-8 shadow-2xl">
        ...
        <p className="mt-6 text-center text-xs text-text-muted">
          ...
          <span className="text-accent-amber cursor-pointer hover:underline">Terms</span> and{' '}
          <span className="text-accent-amber cursor-pointer hover:underline">Privacy Policy</span>.
        </p>
      </div>
    </div>
  )
